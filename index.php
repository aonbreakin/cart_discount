  ...
  <section class="card controls">
    ...
    <div class="results card">
      ...
      <div class="totals">
        ...
        <div>Total (VAT <span id="vat-percent">7</span>%): <strong id="total-vat-amount">—</strong> THB</div>
...
function buildParams(){
  ...
  function row(label,id,type='number',ph=''){const r=createElem('div',{class:'form-row'});r.innerHTML=`<label>${label}<input id="${id}" type="${type}" placeholder="${ph}"></label>`;paramsDiv.appendChild(r);}
